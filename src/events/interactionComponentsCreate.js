    ...
    async execute(interaction) {
        ...
        try {
            ...
            if (interaction.isButton()) {
                ...
                if (!buttonHandler) {
                    return interaction.reply({ content: '❌ Button not found!', flags: [MessageFlags.Ephemeral] });
                }
            ...
            if (interaction.isUserContextMenuCommand() || interaction.isMessageContextMenuCommand()) {
                ...
                if (!command) {
                    return interaction.reply({ content: '❌ Context menu command not found!', flags: [MessageFlags.Ephemeral] });
                }
